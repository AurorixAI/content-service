"""Text-route Smart Verify (no code_execution, no SymPy gate for answers)."""
...
def _build_text_prompt(
    ...
    *,
    ...
    alt_line = "\nОтветь иначе, перепроверь логику.\n" if alt_method else ""
    return (
        "Ты — опытный учитель математики. Реши задачу и дай краткий точный ответ.\n"
        "Задача может быть текстовой, геометрической или логической — без программирования.\n\n"
        f"ID: {task_id}\n"
        f"Вопрос:\n{question}\n\n"
