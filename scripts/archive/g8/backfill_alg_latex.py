#!/usr/bin/env python3
"""Backfill correct_answer_latex + distractor value_latex for G8 ALG."""
...
log = logging.getLogger("backfill_alg_latex")
    ...
    for row in rows:
        ...
        if new_cal != cal or new_dmeta is not dmeta:
            with engine.begin() as conn:
                sets = ["distractor_meta = cast(:dmeta AS jsonb)", "updated_at = NOW()"]
