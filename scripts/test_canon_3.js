...
console.log("  sa:", canonicalAnswerKey(t8_sa));
console.log("  optC:", canonicalAnswerKey(t8_optC));
...
console.log("  sa:", canonicalAnswerKey(t9_sa));
console.log("  optC:", canonicalAnswerKey(t9_optC));

// Test 3: Task 3
const t3_sa = "(-∞; 3]";
const t3_optD = "$(-\\infty; 3]$";
console.log("Task 3 match:", canonicalAnswerKey(t3_sa) === canonicalAnswerKey(t3_optD));
console.log("  sa:", canonicalAnswerKey(t3_sa));
console.log("  optD:", canonicalAnswerKey(t3_optD));
